...
# 配置
DATA_FILE = "./data/train/mobvoi_seq_monkey_general_open_corpus.jsonl"  # 你的文本文件名
OUTPUT_BIN = "./data/train/pre_train_token_ids.bin"
...
with open(OUTPUT_BIN, "wb") as fout:
    ...
    for i, example in enumerate(tqdm(dataset, desc="分词写bin")):
